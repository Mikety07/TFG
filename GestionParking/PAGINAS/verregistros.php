...
$sql = "SELECT z.nombre, v.matricula, v.marca, v.modelo, r.entrada, r.salida, t.importe
        ...
        WHERE r.idZona=z.idZona AND z.idEdificio=e.idEdificio AND r.matricula=v.matricula AND t.idRegistro=r.idRegistro AND e.idEdificio=$idEdificio;";
$resultado_BD = mysqli_query($con, $sql);
?>

<div class="container mt-5">
    <h2 class="text-center mb-4">Registro del edificio <?php echo $edificio['nombre']; ?></h2>
