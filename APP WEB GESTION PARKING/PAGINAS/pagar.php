...
<div class="modal fade" id="modalVehiculoNoRegistrado" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-footer">
            <a href="index.php?page=registrarse" class="btn btn-primary" role="button">Registrar vehículo</a>
...
<div class="modal fade" id="modalVehiculoRegistrado" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="modallabel">EL VEHÍCULO ESTÁ REGISTRADO EN EL SISTEMA</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
